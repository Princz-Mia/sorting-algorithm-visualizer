...
public class CustomButton extends JButton {
    ...
    public enum ButtonStyle {
        PRIMARY(new Color(124, 5, 190, 253), new Color(206, 168, 234), new Color(255, 255, 255, 200), new Color(157, 73, 234)),
        SECONDARY(new Color(203, 209, 219), new Color(58, 70, 81), new Color(81, 92, 108), new Color(230, 239, 255)),
        INFO_ICON(new Color(0, 0, 0, 0), new Color(255, 255, 255), new Color(255, 255, 255, 200), new Color(0, 0, 0, 50)),
